...
import com.e_comapp.android.seller.adapters.DeliveryManListAdapter

class DeliveryManListFragment : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val listAdapter = DeliveryManListAdapter(activity)
