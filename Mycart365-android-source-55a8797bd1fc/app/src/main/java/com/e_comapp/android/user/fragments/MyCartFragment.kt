...
class MyCartFragment : BaseFragment() {
    ...
    private fun init(view: View) {
        ...
        adapter = MyCartRecyclerAdapter(CustConstants.selectedProdList, context)
    ...
    private fun setupEvents() {
        btnCheckout!!.setOnClickListener {
            val intent = Intent(context, SetDeliveryLocationActivity::class.java)
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): MyCartFragment {
