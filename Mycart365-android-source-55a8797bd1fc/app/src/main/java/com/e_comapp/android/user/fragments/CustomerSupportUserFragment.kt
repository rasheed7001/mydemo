...
import com.e_comapp.android.seller.fragments.CustomerSupportFragment
import com.e_comapp.android.user.activities.MainPageActivity

/**
 * A simple [Fragment] subclass.
 * Use the [CustomerSupportUserFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CustomerSupportUserFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        setTitle(getString(R.string.str_custom_support))
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): CustomerSupportFragment {
